        ...
        ZStack(alignment: .bottomTrailing) {
            VStack {
                ...
                HStack {
                    Image(systemName: "lock").padding(.leading)
                    if showPwd {
                        TextField("Please input password", text: $loginViewModel.verifyPassword, onCommit: {
                            
                        }).padding(14)
                    } else {
                        SecureField("Please input password", text: $loginViewModel.verifyPassword, onCommit: {
                ...
                }).alert(Text("Registe Failed"), isPresented: $isPresented, actions: {
